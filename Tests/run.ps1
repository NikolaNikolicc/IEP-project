...
# python main.py --help
python main.py --type "authentication" --authentication-url "http://127.0.0.1:5000" --jwt-secret "JWT_SECRET_KEY" --roles-field "roleId" --owner-role "1" --customer-role "2" --courier-role "3"
